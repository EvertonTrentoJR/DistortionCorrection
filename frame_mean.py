...
for n in range(1, 51):
    exec(
        f'path{n} = "C:/Users/treen/PycharmProjects/pythonProject/dense_point_cloud/setup_paper/bancada/Dense_bancada'
        f'/Test_{n}/"')
...
for n in range(1, 51):
    ...
    exec(f'pixel_map_Z_mean{n} = np.zeros([8,8])+ np.mean(pixel_map_Z_train{n})')
...
for i in range(1, 51):
    exec(
        f'np.save("C:/Users/treen/PycharmProjects/pythonProject/dense_point_cloud/setup_paper/bancada/medias/" + "Dense_pixel_map_X_mean{i}", pixel_map_X_mean{i})')
    exec(
        f'np.save("C:/Users/treen/PycharmProjects/pythonProject/dense_point_cloud/setup_paper/bancada/medias/" + "Dense_pixel_map_Y_mean{i}", pixel_map_Y_mean{i})')
    exec(
        f'np.save("C:/Users/treen/PycharmProjects/pythonProject/dense_point_cloud/setup_paper/bancada/medias/" + "Dense_pixel_map_Z_mean{i}", pixel_map_Z_mean{i})')
